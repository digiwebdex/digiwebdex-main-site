...
const packagesByService: Record<ServiceType, PackageOption[]> = {
  ...
  web_development: [
    ...
    { id: 'web-business', name: { en: 'Business Website', bn: 'বিজনেস ওয়েবসাইট' }, description: { en: '15 Page + CMS', bn: '১৫ পেজ + CMS' }, price: 35000, serviceType: 'web_development', isPopular: true, features: { en: ['15 Pages', 'Custom Design', 'Admin Panel', 'Blog System', 'Analytics', 'Facebook Chatbot AI Setup'], bn: ['১৫টি পেজ', 'কাস্টম ডিজাইন', 'অ্যাডমিন প্যানেল', 'ব্লগ সিস্টেম', 'অ্যানালিটিক্স', 'ফেসবুক চ্যাটবট AI সেটআপ'] } },
    { id: 'web-ecommerce', name: { en: 'E-commerce', bn: 'ই-কমার্স' }, description: { en: 'Full Online Store', bn: 'পূর্ণ অনলাইন স্টোর' }, price: 50000, serviceType: 'web_development', features: { en: ['Unlimited Products', 'Payment Gateway', 'Inventory Management', 'Order Tracking', 'Mobile App Ready', 'Facebook Chatbot AI Setup'], bn: ['আনলিমিটেড প্রোডাক্ট', 'পেমেন্ট গেটওয়ে', 'ইনভেন্টরি ম্যানেজমেন্ট', 'অর্ডার ট্র্যাকিং', 'মোবাইল অ্যাপ রেডি', 'ফেসবুক চ্যাটবট AI সেটআপ'] } },
  ],
